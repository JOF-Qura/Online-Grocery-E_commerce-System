...
<html>
<head>
<title>Grocery Store | Bread & Bakery </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<?php
					...
					$view_prod_query = "SP_Product57to60_JOIN_IMAGE";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SP_Product61to64_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SP_Product65to68_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
