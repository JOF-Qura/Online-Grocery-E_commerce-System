...
<html>
<head>
<title>Grocery Store | Frozen Food </title>
<!-- for-mobile-apps -->
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Frozen Foodt</h4>
							<p>
								Freezing food preserves it from the time it is prepared to the time it is eaten. Since 
								early times, farmers, fishermen, and trappers have preserved grains and produce in 
								unheated buildings during the winter season.</p>
						</div>
					</div>
					<h4>Frozen Food</h4>
					<ol>
						<li>Hotdogs</li>
						<li>Poultry, Beef, & Pork</li>
						<li>Nuggets</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Chicken</h4>
							<p>Frozen chicken provides some health benefits because of its mineral content. 
								Its zinc content activates enzymes that your cells rely on to function properly 
								and also plays a key role in immune function.</p>
						</div>
					</div>
					<h4>Frozen Chicken</h4>
					<ol>
						<li>Thighs</li>
						<li>Breast</li>
						<li>Wings</li>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Beef</h4>
							<p>When it comes to fresh meat like beef, veal, or lamb, 
								you should know that these foods can last for several 
								months in the freezer, depending on what type of meat they are.</p>
						</div>
					</div>
					<h4>Frozen Beef</h4>
					<ol>
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
				...
				<?php
					$serverName = "QUUUUURA"; //serverName\instanceName
					...
					$view_prod_query = "SP_Product45to48_JOIN_IMAGE";//select query for viewing users.  
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<a href="single.php?id=<?php echo $Prod_ID ?>"><?php echo '<img src="data:image;base64, '.base64_encode($Img_data).'" class="img-responsive" >' ?></a>
				...
				<?php
					...
					$view_prod_query = "SP_Product49to52_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SP_Product53to56_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
