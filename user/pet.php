		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT37to40";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT41to44";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT9to12";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
