...
<html>
<head>
<title>Grocery | Households </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			...
			<h3>Household Products</h3>
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_CLEANING";//select query for viewing users.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_LAUNDRYNEEDS";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
