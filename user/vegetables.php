...
<html>
<head>
<title>Grocery | Fruits & Vegetables </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Fruits</h4>
							<p>Try the sweetness, sourness, saltyness of our fruits</p>
						</div>
					</div>
					<h4>Fresh Fruits</h4>
					<ol>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Vegetables</h4>
							<p>Vegetables for your healthy living.</p>
						</div>
					</div>
					<h4>Fresh Vegtables</h4>
					<ol>
						<li>Health</li>
						<li>is</li>
						<li>Important</li>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							...
							<p>Eating fruits and vegetables on a regular basis can lower cholesterol levels in the body.</p>
						</div>
					</div>
					<h4>Fresh Fruits and Vegetables</h4>
					<ol>
						<li>Strengthen the body’s defenses</li>
						<li>Improve memory and protect brain cells</li>
						<li>The body is fresher and energetic</li>
					</ol>
				</div>
				<div class="clearfix"> </div>
			</div>
			...
			<h3 class="w3l_fruit">Fruits & Vegetables</h3>
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT13to16";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT17to20";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
                ...
                <?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT21to24";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
