		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
				...
				<?php
					...
					$view_prod_query = "SP_Product13to16_JOIN_IMAGE";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SP_Product17to20_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
                ...
                <?php
					...
					$view_prod_query = "SP_Product21to24_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
