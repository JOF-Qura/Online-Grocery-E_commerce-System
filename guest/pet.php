...
<html>
<head>
<title>Grocery Store | Pet Food </title>
<!-- for-mobile-apps -->
	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_banner9 w3l_banner_nav_right_banner_pet">
				...
				<p>Food for your Mighty Friend</p>
			</div>
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<?php
					...
					$view_prod_query = "SP_Product37to40_JOIN_IMAGE";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SP_Product41to44_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SP_Product9to12_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
