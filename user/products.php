		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Food</h4>
							<p>Food, substance consisting essentially of 
								protein, carbohydrate, fat, and other nutrients used in 
								the body of an organism to sustain growth and vital processes 
								and to furnish energy.</p>
						</div>
					</div>
					<h4>Food</h4>
					<ol>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					...
					<ol>
						<li>Have fruits & vegetables if you want to lead a fruitful life</li>
						<li>Eat fruits plenty, keep body wealthyt</li>
						<li>Vegetables keep you healthy</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Beverages</h4>
							<p>Whether you are looking for water, tea, coffee, milk, juice or beer, everything comes under beverage.</p>
						</div>
					</div>
					<h4>Beverages</h4>
					<ol>
						<li>An experience like never before</li>
						<li>Beverages you love</li>
						<li>A taste you can’t forget</li>
					</ol>
				</div>
				<div class="clearfix"> </div>
			</div>
			...
			<h3>Popular Brands</h3>
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_FrozenFoodsBESTSELL";//select query for viewing users.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_BreadAndBakeryBESTSELL";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_BeveragesBESTSELL";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
