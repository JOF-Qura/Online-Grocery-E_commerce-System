...
<html>
<head>
<title>Grocery | Frozen Food </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			...
			<h3 class="w3l_fruit">Frozen Food</h3>
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT45to48";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT49to52";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT53to56";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
