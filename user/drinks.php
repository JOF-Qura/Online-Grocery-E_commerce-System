		...
		<div class="w3l_banner_nav_right">
			...
			<h3>Beverages</h3>
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_SOFTDRINKS";//select query for viewing users.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_JUICES";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT_ENERGYDRINKS";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
