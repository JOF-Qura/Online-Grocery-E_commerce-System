...
<html>
<head>
<title>Grocery | Bread & Bakery </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			...
			<h3 class="w3l_fruit">Bread & Bakery</h3>
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT57to60";//select query for viewing users.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT61to64";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<?php
					...
					$view_prod_query = "SELECT * FROM SALES_V_LIST_PRODUCT65to68";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
