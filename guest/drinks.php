...
<html>
<head>
<title>Grocery Store | Beverages </title>
<!-- for-mobile-apps -->
		...
		<div class="w3l_banner_nav_right">
			...
			<h3>Beverages</h3>
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_Product25to28_JOIN_IMAGE";//select query for viewing users.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_Product29to32_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_Product33to36_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
