		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_FrozenFBESTSELL_JOIN_IMAGE";//select query for viewing users.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_BreadAndBBESTSELL_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					$view_prod_query = "SP_BeveragesBESTSELL_JOIN_IMAGE";//select query for viewing users.  
					$run = sqlsrv_query($conn, $view_prod_query);//here run the sql query.  
