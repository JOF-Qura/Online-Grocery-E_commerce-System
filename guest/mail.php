...
<html>
<head>
<title>Grocery Store | Mail Us </title>
<!-- for-mobile-apps -->
			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>Quezon City</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="mailto:ferrerjoshua305@gmail.com">ferrerjoshua305@gmail.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(+63)977 0919 259</span></li>
					</ul>
				</div>
